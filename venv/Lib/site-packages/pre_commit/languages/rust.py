...
def in_env(prefix: Prefix) -> Generator[None, None, None]:
    target_dir = prefix.path(helpers.environment_dir(ENVIRONMENT_DIR, C.DEFAULT))
    with envcontext(get_env_patch(target_dir)):
        yield


def _add_dependencies(cargo_toml_path: str, additional_dependencies: Set[str]) -> None:
...
def install_environment(
    ...
    directory = prefix.path(helpers.environment_dir(ENVIRONMENT_DIR, C.DEFAULT))
