...
def _add_config_option(parser: argparse.ArgumentParser) -> None:
    parser.add_argument(
        "-c", "--config", default=C.CONFIG_FILE, help="Path to alternate config file"
    )
...
def _add_run_options(parser: argparse.ArgumentParser) -> None:
    ...
    mutex_group.add_argument(
        "--files", nargs="*", default=[], help="Specific filenames to run hooks on."
    )
    parser.add_argument(
    ...
    parser.add_argument("--remote-branch", help="Remote branch ref used by `git push`.")
    parser.add_argument(
        "--from-ref",
        "--source",
        "-s",
    ...
    parser.add_argument("--remote-name", help="Remote name used by `git push`.")
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    clean_parser = subparsers.add_parser("clean", help="Clean out pre-commit files.")
    ...
    hook_impl_parser.add_argument("--skip-on-missing-config", action="store_true")
    ...
    migrate_config_parser = subparsers.add_parser(
        "migrate-config", help="Migrate list configuration to new map configuration."
    )
    ...
    try_repo_parser.add_argument("repo", help="Repository to source hooks from.")
    ...
    with error_handler(), logging_handler(args.color):
        ...
        raise AssertionError(f"Command {args.command} failed to exit with a returncode")
