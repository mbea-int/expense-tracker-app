...
class PipInstall(object):
    ...
    def _records_text(self, files):
        record_data = "\n".join(
            "{},,".format(
                os.path.relpath(
                    ensure_text(str(rec)), ensure_text(str(self._image_dir))
                )
            )
            for rec in files
        )
    ...
    def _generate_new_files(self):
        ...
        try:
            ...
            rel = os.path.relpath(
                ensure_text(str(self._creator.script_dir)),
...
class ScriptMakerCustom(ScriptMaker):
    ...
    def _write_script(self, names, shebang, script_bytes, filenames, ext):
        ...
        super(ScriptMakerCustom, self)._write_script(
            names, shebang, script_bytes, filenames, ext
        )
