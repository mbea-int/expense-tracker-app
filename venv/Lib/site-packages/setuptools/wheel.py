...
class Wheel:
    ...
    def tags(self):
        ...
        return itertools.product(
            self.py_version.split("."), self.abi.split("."), self.platform.split(".")
        )
    ...
    def _convert_metadata(zf, destination_eggdir, dist_info, egg_info):
        ...
        os.rename(
            os.path.join(egg_info, "METADATA"), os.path.join(egg_info, "PKG-INFO")
        )
        setup_dist = setuptools.Distribution(
            attrs=dict(install_requires=install_requires, extras_require=extras_require)
        )
